...
<!--            <Icon size="150" type="ios-bonfire-outline" />-->
          ...
          <Card id="select-card">
            ...
            <Row>
              ...
              <Col span="12">
                <ColorPicker style="z-index: 0;" v-model="color" alpha/>
              </Col>
            </Row><br>
          </Card>
    ...
    <Modal
      ...
      <Button @click="addType" style="margin-left: 27%;">添加Type</Button>
    </Modal>
    ...
    <Modal
      ...
      <Button @click="addBranch"  style="margin-left: 27%;">添加Branch</Button>
    </Modal>
