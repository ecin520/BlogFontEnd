    ...
    //   })
      let info = '# Self Introduction\n' +
        ...
        '![](https://img-blog.csdnimg.cn/20190922175000168.png)';
          ...
          this.self_html = marked(info,{sanitize: true});
